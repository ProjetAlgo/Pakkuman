...
public class MazeGenerator {	
	...
	public static void main(String[] args) {
		...
		int y = args.length >= 1 ? (Integer.parseInt(args[0])) : sizeY;
		int x = args.length >= 2 ? (Integer.parseInt(args[1])) : sizeX;
		int monstres = args.length >= 3 ? (Integer.parseInt(args[2])) : qteMonstres;
		int bonbons = args.length == 4 ? (Integer.parseInt(args[3])) : qteBonbons;
		...
		position[px][py]=1;
		System.out.println("\tPakkuman: ("+py+","+px+")");
		int fx=px, fy=py;
